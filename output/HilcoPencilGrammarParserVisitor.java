...
public interface HilcoPencilGrammarParserVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link HilcoPencilGrammarParser#accessList}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitAccessList(HilcoPencilGrammarParser.AccessListContext ctx);
	/**
	 * Visit a parse tree produced by {@link HilcoPencilGrammarParser#accessorMessage}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitAccessorMessage(HilcoPencilGrammarParser.AccessorMessageContext ctx);
	/**
